...
const level5: LevelData = {
  ...
  rocketCorridor: {
    ...
    movingSpikes: [
      ...
      { offsetX: 800,  amplitude: 50, phase: 1.0, speed: 0.055 },
      { offsetX: 1300, amplitude: 60, phase: 0.5, speed: 0.04 },
      { offsetX: 1800, amplitude: 55, phase: 2.0, speed: 0.05 },
      { offsetX: 2300, amplitude: 50, phase: 0.8, speed: 0.06 },
      { offsetX: 2800, amplitude: 45, phase: 1.5, speed: 0.045 },
      { offsetX: 3300, amplitude: 55, phase: 0.3, speed: 0.05 },
    ],
    rotatingBlocks: [
      { offsetX: 550,  gapOffset: -0.2, size: 22 },
      { offsetX: 1100, gapOffset:  0.2, size: 22 },
      { offsetX: 1900, gapOffset:  0,   size: 22 },
      { offsetX: 2600, gapOffset: -0.3, size: 22 },
      { offsetX: 3500, gapOffset:  0.2, size: 22 },
    ],
    coins: [
      { offsetX: 650,  gapOffset: 0 },
      { offsetX: 1400, gapOffset: -0.25 },
      { offsetX: 2200, gapOffset: 0.25 },
      { offsetX: 3000, gapOffset: 0 },
      { offsetX: 3700, gapOffset: -0.2 },
    ],
  },
