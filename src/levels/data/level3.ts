...
const level3: LevelData = {
  ...
  obstacles: [
    ...
    { x: 800, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' }, // Мега-прыжок на старте
    { x: 950, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    ...
    { x: 1550, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    { x: 1700, y: GROUND_Y - 100, width: 30, height: 30, type: 'jump_ring_yellow' },
    ...
    // === Секция 2 (2500-5000): Ледяной мост и Гравитация ===
    { x: 2600, y: GROUND_Y - 20, width: 20, height: 20, type: 'spike' },
    { x: 2700, y: GROUND_Y - 80, width: 40, height: 80, type: 'gravity_portal_up' }, // Гравитация вверх!
    { x: 2900, y: 70, width: 80, height: 15, type: 'moving_platform', moveRange: 80, moveSpeed: 1.8, moveAxis: 'x' }, // На потолке
    { x: 3100, y: 70, width: 20, height: 20, type: 'spike' },
    { x: 3300, y: 50, width: 40, height: 80, type: 'gravity_portal_down' }, // Вниз
    ...
    { x: 3950, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    { x: 4100, y: GROUND_Y - 150, width: 90, height: 15, type: 'platform' },
    { x: 4300, y: GROUND_Y - 150, width: 20, height: 150, type: 'laser' }, // Лазер под потолком
    { x: 4400, y: GROUND_Y - 110, width: 70, height: 15, type: 'platform' },
    { x: 4460, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_pink' },
    { x: 4700, y: GROUND_Y - 130, width: 80, height: 15, type: 'platform' },
    { x: 4900, y: GROUND_Y - 20, width: 20, height: 20, type: 'spike' },

    // === Секция 3 (5000-7500): Зал стражей и Скорость ===
    { x: 5000, y: GROUND_Y - 50, width: 70, height: 15, type: 'moving_platform', moveRange: 90, moveSpeed: 2.0, moveAxis: 'x' },
    { x: 5150, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_fast' }, // Ускорение!
    { x: 5350, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 5400, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 5450, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 5600, y: GROUND_Y - 100, width: 80, height: 15, type: 'platform' },
    { x: 5750, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    ...
    { x: 6650, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_normal' }, // Замедление к норме
    ...
    // === Секция 4 (7500-10000): Лабиринты ===
    { x: 7600, y: GROUND_Y - 90, width: 70, height: 15, type: 'moving_platform', moveRange: 60, moveSpeed: 1.7, moveAxis: 'y' },
    { x: 7800, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' },
    { x: 8000, y: GROUND_Y - 180, width: 20, height: 180, type: 'laser' },
    { x: 8200, y: GROUND_Y - 50, width: 80, height: 15, type: 'moving_platform', moveRange: 100, moveSpeed: 2.0, moveAxis: 'x' },
    { x: 8350, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    { x: 8500, y: GROUND_Y - 120, width: 80, height: 15, type: 'platform' },
    { x: 8650, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_yellow' },
    { x: 8850, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    ...
    { x: 14550, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_superfast' }, // Финальный рывок
    ...
    { x: 15000, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' },
    { x: 15200, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_yellow' },
    { x: 15400, y: GROUND_Y - 150, width: 20, height: 150, type: 'laser' },
    { x: 15600, y: GROUND_Y - 70, width: 100, height: 15, type: 'platform' },
    { x: 15750, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    { x: 15900, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    { x: 16100, y: GROUND_Y - 150, width: 20, height: 150, type: 'laser' },
    { x: 16200, y: GROUND_Y - 120, width: 80, height: 15, type: 'platform' },
    { x: 16350, y: GROUND_Y - 20, width: 20, height: 20, type: 'spike' },
    { x: 16500, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_normal' }, // Сброс перед боссом
  ],
