...
const level4: LevelData = {
  ...
  obstacles: [
    ...
    { x: 1700, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' },
    { x: 1850, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    ...
    // === Секция 2 (2500-5000): Огненные горы (Гравитация и ускорение) ===
    { x: 2600, y: GROUND_Y - 20, width: 20, height: 20, type: 'spike' },
    { x: 2700, y: GROUND_Y - 80, width: 40, height: 80, type: 'gravity_portal_up' },
    { x: 2900, y: 70, width: 80, height: 15, type: 'platform' },
    { x: 3100, y: 70, width: 20, height: 20, type: 'spike' },
    { x: 3300, y: 50, width: 70, height: 15, type: 'moving_platform', moveRange: 70, moveSpeed: 1.2, moveAxis: 'y' },
    { x: 3500, y: 70, width: 20, height: 20, type: 'spike' },
    { x: 3600, y: 50, width: 40, height: 80, type: 'gravity_portal_down' },
    { x: 3750, y: GROUND_Y - 80, width: 80, height: 15, type: 'platform' },
    { x: 4000, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_fast' },
    ...
    { x: 4500, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_yellow' },
    { x: 4800, y: GROUND_Y - 70, width: 90, height: 15, type: 'platform' },

    // === Секция 3 (5000-7500): Кузница (Разрушаемые блоки и лазеры) ===
    ...
    { x: 5400, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    { x: 5600, y: GROUND_Y - 90, width: 80, height: 15, type: 'platform' },
    { x: 5800, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 5850, y: GROUND_Y - 60, width: 30, height: 30, type: 'breakable_block' },
    { x: 5900, y: GROUND_Y - 90, width: 30, height: 30, type: 'breakable_block' },
    { x: 6100, y: GROUND_Y - 110, width: 70, height: 15, type: 'moving_platform', moveRange: 60, moveSpeed: 1.3, moveAxis: 'y' },
    { x: 6350, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_yellow' },
    { x: 6500, y: GROUND_Y - 80, width: 90, height: 15, type: 'platform' },
    { x: 6700, y: GROUND_Y - 150, width: 20, height: 150, type: 'laser' },
    ...
    // === Секция 4 (7500-9500): Поле огня (Суперскорость) ===
    { x: 7500, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_superfast' },
    { x: 7700, y: GROUND_Y - 130, width: 80, height: 15, type: 'moving_platform', moveRange: 70, moveSpeed: 1.7, moveAxis: 'y' },
    { x: 7900, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' },
    { x: 8100, y: GROUND_Y - 90, width: 80, height: 15, type: 'platform' },
    { x: 8300, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 8350, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 8400, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
    { x: 8600, y: GROUND_Y - 110, width: 70, height: 15, type: 'moving_platform', moveRange: 55, moveSpeed: 1.4, moveAxis: 'y' },
    { x: 8800, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    ...
    // === Секция 5 (9500-12000): Нормализация и прыжки по сферам ===
    { x: 9500, y: GROUND_Y - 80, width: 40, height: 80, type: 'speed_portal_normal' },
    ...
    { x: 10700, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    { x: 10900, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_yellow' },
    { x: 11050, y: GROUND_Y - 100, width: 70, height: 15, type: 'moving_platform', moveRange: 70, moveSpeed: 1.6, moveAxis: 'y' },
    { x: 11200, y: GROUND_Y - 20, width: 20, height: 20, type: 'spike' },
    { x: 11400, y: GROUND_Y - 70, width: 90, height: 15, type: 'platform' },
    { x: 11600, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' },
    ...
    { x: 14400, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_yellow' },
    { x: 14700, y: GROUND_Y - 110, width: 70, height: 15, type: 'moving_platform', moveRange: 55, moveSpeed: 1.4, moveAxis: 'y' },
    { x: 14900, y: GROUND_Y - 150, width: 20, height: 150, type: 'laser' },
    ...
    { x: 16150, y: GROUND_Y - 150, width: 30, height: 30, type: 'jump_ring_pink' },
    { x: 16300, y: GROUND_Y - 100, width: 80, height: 15, type: 'moving_platform', moveRange: 65, moveSpeed: 1.5, moveAxis: 'y' },
    { x: 16500, y: GROUND_Y - 10, width: 40, height: 10, type: 'jump_pad_red' },
    { x: 16700, y: GROUND_Y - 80, width: 90, height: 15, type: 'platform' },
    { x: 16900, y: GROUND_Y - 30, width: 30, height: 30, type: 'breakable_block' },
  ...
  rocketCorridor: {
    ...
    movingSpikes: [
      ...
      { offsetX: 800, amplitude: 45, phase: 1.0, speed: 0.05 },
      { offsetX: 1300, amplitude: 60, phase: 0.5, speed: 0.035 },
      { offsetX: 1800, amplitude: 50, phase: 2.0, speed: 0.045 },
      { offsetX: 2300, amplitude: 55, phase: 0.7, speed: 0.05 },
      { offsetX: 2800, amplitude: 45, phase: 1.5, speed: 0.04 },
      { offsetX: 3200, amplitude: 50, phase: 0.3, speed: 0.055 },
    ],
    coins: [
      { offsetX: 600, gapOffset: 0 },
      { offsetX: 1100, gapOffset: -0.3 },
      { offsetX: 1700, gapOffset: 0.3 },
      { offsetX: 2500, gapOffset: 0 },
      { offsetX: 3100, gapOffset: -0.2 },
    ],
  },
